...
export const ALLDATA: Entry[] = [
  {y:2017,date:"30/03/2017",artist:"2CELLOS",venue:"Mediolanum Forum",city:"Assago",with:["Alessia P","Enrico A","Davide B"],vicinanza:6,voto:3,canzoniNote:"na",from:"g",km:133},
  {y:2017,date:"25/05/2017",artist:"Marco Masini",venue:"Politeama Genovese",city:"Genova",with:["Silvia P"],vicinanza:2,voto:3,canzoniNote:"na",from:"g",km:2},
  {y:2017,date:"10/07/2017",artist:"Imagine Dragons",venue:"Arena di Verona",city:"Verona",with:["Marco D","Fra G","Isabel C"],cost:48,vicinanza:6,voto:4,canzoniNote:"na",from:"g",km:238},
  {y:2019,date:"19/06/2019",artist:"Ed Sheeran",venue:"Stadio San Siro",city:"Milano",with:["Isa"],vicinanza:6,voto:4,canzoniNote:3,from:"g",km:154},
  {y:2020,date:"15/02/2020",artist:"World of Hans Zimmer",venue:"DRFG Arena",city:"Brno",with:["Isa"],gift:true,vicinanza:5,voto:5,canzoniNote:5,from:"g",km:978},
  {y:2022,date:"24/05/2022",artist:"Fulminacci",venue:"Fabrique",city:"Milano",with:["Fra M","Matteo A"],vicinanza:3,voto:3,canzoniNote:3,from:"g",km:140},
  {y:2022,date:"14/07/2022",artist:"Blanco",venue:"Arena del Mare",city:"Genova",with:["Dicce"],cost:39.78,vicinanza:4,voto:3,canzoniNote:3,from:"g",km:4},
  {y:2022,date:"20/07/2022",artist:"Caparezza",venue:"Arena del Mare",city:"Genova",with:["Mamma","Barbi","Amed"],cost:37.35,vicinanza:3,voto:4,canzoniNote:2,from:"g",km:4},
  {y:2022,date:"26/07/2022",artist:"Pinguini Tattici Nucleari",venue:"Arena del Mare",city:"Genova",with:["Matteo A"],cost:45,vicinanza:3,voto:3,canzoniNote:3,from:"g",km:4},
  {y:2022,date:"06/09/2022",artist:"Fulminacci",venue:"Circolo Magnolia",city:"Milano",with:["Marco S","Ornella","Daniela"],cost:22.8,vicinanza:2,voto:3,canzoniNote:3,from:"g",km:140},
  {y:2022,date:"16/09/2022",artist:"Tananai e LRDL",venue:"Arena del Mare",city:"Genova",with:["Dani","Giorgia B"],cost:30.68,vicinanza:3,voto:3,canzoniNote:2,from:"g",km:4},
  {y:2022,date:"24/11/2022",artist:"Emma Nolde",venue:"Santeria Toscana 31",city:"Milano",with:["Espi"],vicinanza:2,voto:4,canzoniNote:2,from:"g",km:138},
  {y:2023,date:"17/02/2023",artist:"Emma Nolde",venue:"Cinema Teatro Magda Olivero",city:"Saluzzo",with:["Espi"],vicinanza:3,voto:4,canzoniNote:4,from:"g",km:151},
  {y:2023,date:"18/03/2023",artist:"Emma Nolde",venue:"Giardini Luzzati",city:"Genova",with:["Espi"],vicinanza:1,voto:4,canzoniNote:4,from:"g",km:2},
  {y:2023,date:"22/03/2023",artist:"Eugenio in Via di Gioia",venue:"Teatro della Concordia",city:"Venaria Reale",with:["Anna M"],cost:36.81,vicinanza:3,voto:3,canzoniNote:2,from:"g",km:150},
  {y:2023,date:"26/03/2023",artist:"Emma Nolde",venue:"Apollo Club",city:"Milano",with:["Katarina"],vicinanza:2,voto:2,canzoniNote:4,from:"m",km:3},
  ...
  {y:2023,date:"25/06/2023",artist:"Coldplay",venue:"Stadio San Siro",city:"Milano",with:["Silvia C","Alessia P"],cost:110,vicinanza:6,voto:3,canzoniNote:3,from:"m",km:6},
  ...
  {y:2024,date:"22/06/2024",artist:"Michael Kiwanuka",venue:"La Prima Estate",city:"Lido di Camaiore",with:["Camilla C"],cost:0,vicinanza:2,voto:4,canzoniNote:2},
  ...
  {y:2024,date:"10/10/2024",artist:"Dargen D'Amico",venue:"Teatro degli Arcimboldi",city:"Milano",with:[],cost:40.44,vicinanza:3,voto:4,canzoniNote:3,from:"m",km:10},
  {y:2024,date:"29/11/2024",artist:"Emma Nolde",venue:"The Cage",city:"Livorno",with:["Cami <3","Espi","Cate"],cost:16.09,vicinanza:2,voto:3,canzoniNote:4,from:"g",km:187},
  {y:2024,date:"04/12/2024",artist:"Fast Animals and Slow Kids",venue:"Alcatraz",city:"Milano",with:["Anna M"],cost:37.95,vicinanza:3,voto:3,canzoniNote:2,from:"m",km:6},
  {y:2024,date:"13/12/2024",artist:"Giovanni Ti Amo",venue:"YellowSquare",city:"Milano",with:["Valeria"],cost:7.5,vicinanza:2,voto:3,canzoniNote:4,from:"m",km:4},
  {y:2025,date:"27/01/2025",artist:"Emma Nolde",venue:"Arci Bellezza",city:"Milano",with:["Cami <3"],cost:17.25,vicinanza:2,voto:3,canzoniNote:4,from:"m",km:3},
  {y:2025,date:"30/01/2025",artist:"Questo e Quello",venue:"Legend Club",city:"Milano",with:["Gio Giga"],cost:"na",vicinanza:2,voto:1,canzoniNote:3,from:"m",km:8},
  {y:2025,date:"12/03/2025",artist:"Ofenbach",venue:"Arci Bellezza",city:"Milano",with:[],cost:24.99,vicinanza:2,voto:3,canzoniNote:2,from:"m",km:3},
  {y:2025,date:"23/03/2025",artist:"Benjamin Clementine",venue:"Alcatraz",city:"Milano",with:[],cost:41.5,vicinanza:3,voto:3,canzoniNote:3,from:"m",km:6},
  {y:2025,date:"27/05/2025",artist:"Imagine Dragons",venue:"Ippodromo Snai La Maura",city:"Milano",with:["Cami <3","Marco D","Ludo"],cost:123.05,vicinanza:2,voto:4,canzoniNote:3,from:"m",km:8},
  {y:2025,date:"11/06/2025",artist:"Pinguini Tattici Nucleari",venue:"Stadio San Siro",city:"Milano",with:["Fra M"],cost:78.97,vicinanza:3,voto:2,canzoniNote:4,from:"m",km:6},
  {y:2025,date:"22/06/2025",artist:"Gazzelle",venue:"Stadio San Siro",city:"Milano",with:["Cami <3"],gift:true,vicinanza:5,voto:4,canzoniNote:3,from:"m",km:6},
  {y:2025,date:"24/06/2025",artist:"Linkin Park",venue:"Ippodromo Snai La Maura",city:"Milano",with:["Marco D","Fra G","Elena"],cost:122.72,vicinanza:2,voto:4,canzoniNote:2,from:"m",km:8},
  {y:2025,date:"10/07/2025",artist:"Benjamin Clementine",venue:"Castello Sforzesco",city:"Milano",with:[],gift:true,vicinanza:3,voto:4,canzoniNote:3,from:"m",km:2},
  {y:2025,date:"04/10/2025",artist:"Olly",venue:"Palateknoship",city:"Genova",with:["Marco D","Ludo","Sammy"],cost:52.29,vicinanza:3,voto:3,canzoniNote:4,from:"g",km:8},
  {y:2025,date:"30/10/2025",artist:"Carl Brave",venue:"Fabrique",city:"Milano",with:["Ditta"],cost:36.91,vicinanza:3,voto:3,canzoniNote:3,from:"m",km:9},
  {y:2025,date:"21/11/2025",artist:"Dardust",venue:"Teatro San Babila",city:"Milano",with:[],cost:60.46,vicinanza:3,voto:2,canzoniNote:1,from:"m",km:3},
  {y:2025,date:"21/11/2025",artist:"Mumford & Sons",venue:"Unipol Forum",city:"Assago",with:["Cami <3","Anna M"],cost:87.63,vicinanza:2,voto:5,canzoniNote:3,from:"m",km:10},
  {y:2025,date:"25/11/2025",artist:"Dutch Nazari",venue:"Santeria Toscana 31",city:"Milano",with:["Cami <3"],cost:20.96,vicinanza:2,voto:3,canzoniNote:4,from:"m",km:3},
  {y:2025,date:"26/11/2025",artist:"Anna Carol",venue:"Arci Bellezza",city:"Milano",with:[],cost:17.25,vicinanza:2,voto:4,canzoniNote:3,from:"m",km:3},
  {y:2025,date:"03/12/2025",artist:"Zen Circus",venue:"Alcatraz",city:"Milano",with:["Cami <3"],cost:33.5,vicinanza:2,voto:3,canzoniNote:2,from:"m",km:6},
  {y:2026,date:"13/01/2026",artist:"Ex Otago",venue:"Crazy Bull Café",city:"Genova",with:["Cami <3"],cost:32,vicinanza:2,voto:4,canzoniNote:3,from:"g",km:7},
  {y:2026,date:"05/02/2026",artist:"Giovanni Ti Amo",venue:"Arci Bellezza",city:"Milano",with:["Espi","Cate"],cost:13.8,vicinanza:2,voto:3,canzoniNote:3,from:"m",km:3},
  {y:2026,date:"10/04/2026",artist:"Nitro",venue:"Crazy Bull Café",city:"Genova",with:["Cami <3"],gift:true,vicinanza:3,voto:4,canzoniNote:2,from:"g",km:7},
  {y:2026,date:"15/04/2026",artist:"Fulminacci",venue:"Unipol Forum",city:"Assago",with:["Perla","Waitz"],cost:41.62,vicinanza:2,voto:4,canzoniNote:4,from:"m",km:10},
  ...
  {y:2026,date:"03/07/2026",artist:"Florence + The Machine",venue:"Ippodromo Snai San Siro",city:"Milano",with:["Cami <3"],cost:92.29,vicinanza:3,voto:5,canzoniNote:3,from:"m",km:5},
  {y:2026,date:"05/07/2026",artist:"Foo Fighters",venue:"Ippodromo Snai La Maura",city:"Milano",with:["Annap"],cost:92,vicinanza:4,voto:4,canzoniNote:1,from:"m",km:8},
  {y:2026,date:"15/07/2026",artist:"Frah Quintale",venue:"Arena del Mare",city:"Genova",with:["Cami <3"],accredito:true,vicinanza:2,voto:4,canzoniNote:3,from:"g",km:4},
  {y:2026,date:"17/07/2026",artist:"Mannarino",venue:"Arena del Mare",city:"Genova",with:["Cami <3"],cost:54.14,vicinanza:1,voto:3,canzoniNote:2,from:"g",km:4},
  {y:2026,date:"18/07/2026",artist:"Sayf",venue:"Arena del Mare",city:"Genova",with:["Cami <3"],cost:50.03,vicinanza:4,voto:3,canzoniNote:2,from:"g",km:4},
  {y:2026,date:"22/07/2026",artist:"Emma Nolde",venue:"Arena del Mare",city:"Genova",with:["Espi","Cate"],accredito:true,vicinanza:1,voto:4,canzoniNote:4,from:"g",km:4},
  {y:2026,date:"24/07/2026",artist:"Caparezza",venue:"Arena del Mare",city:"Genova",with:["Cami <3","Anna DF","Richi"],cost:60.99,vicinanza:2,voto:5,canzoniNote:4,from:"g",km:4},
  {y:2026,date:"25/07/2026",artist:"I Cani",venue:"Arena del Mare",city:"Genova",with:["Cami <3"],cost:44.28,vicinanza:3,voto:3,canzoniNote:2,from:"g",km:4},
